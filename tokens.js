        ...
        dark: {
            color: {
                text: {
                    ...
                    tertiary:  primitives.color.gray[500],
                    placeholder: primitives.color.gray[500],
                    inverse:   primitives.color.gray[800],
                    link:      primitives.color.orange[400],
                    linkHover: primitives.color.orange[300],
                },
                bg: {
                    page:      primitives.color.gray[900],
                    surface:   primitives.color.gray[800],
                    surfaceRaised: primitives.color.gray[700],
                    muted:     primitives.color.gray[700],
